...
async function handler(req: VercelRequest, res: VercelResponse) {
  console.log('[MIGRATE] Starting migration endpoint...')
  ...
  try {
    ...
    console.log('[MIGRATE] video_shares table created')
